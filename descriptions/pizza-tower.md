...
- Z, K, or Space to jump
- X or L to dash, grab, or throw
- Down in midair to dive or ground pound
- Up + Z to high jump

## Platform Support

Pizza Tower can be played on desktop browsers and is compatible with most modern systems including mobile devices.

## Why Play

Pizza Tower offers an engaging experience with dynamic gameplay and various challenges. Perfect for both casual gaming and competitive play, this game provides entertainment for players of all skill levels.
